...
export default function WhatsAppButton({ lang = 'en' }: { lang?: string }) {
  ...
  const greeting = lang === 'ar' ? 'مرحباً، أود الاستفسار عن رحلات السفاري في كينيا.' : "Hello! I'd like to ask about your Kenya safari tours."
  ...
  return (
    <a
      ...
      aria-label={label}
      onClick={() => trackEvent('whatsapp_click', { ...pageContext(lang), cta_location: 'floating_button', contact_method: 'whatsapp' })}
