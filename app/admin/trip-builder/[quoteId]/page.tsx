 ...
 */
function hotelRowsFromItinerary(
  days: ItineraryDay[],
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {!hasBuilderState && (
        <p className="mb-4 text-sm text-amber-700 bg-amber-50 rounded-lg border border-amber-200 px-4 py-3">
          Pricing hasn&apos;t been built for this quote yet — hotel rows are pre-filled from the itinerary
          where possible. Review them, add transport and parks, then Save to create its Standard/Premium
          track versions.
        </p>
      )}
