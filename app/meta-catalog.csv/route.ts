...
import { buildMetaPrimaryFeed, type MetaCatalogDeparture, type MetaCatalogTour } from '@/lib/meta-catalog'

export const dynamic = 'force-dynamic'

const headers = {
  'Content-Type': 'text/csv; charset=utf-8',
  'Content-Disposition': 'inline; filename="safari-adventure-riders-meta-catalog.csv"',
...
export async function GET() {
  ...
  if (tourResult.error || departureResult.error) {
    console.error('Meta catalog feed query failed', {
  ...
  return new Response(buildMetaPrimaryFeed(
